...
<html lang="en">
 <head>
  ...
  <title><?php echo esc_html($email_subject); ?></title><!--[if (mso 16)]>
    <style type="text/css">
			...
			<td align="left" bgcolor="#efefef" style="padding:15px 20px 0;Margin:0;background-color:#efefef;background:linear-gradient(0deg, #EFEFEF 0%, #FFFFFF 100%)">
				<table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
					...
					<?php if ($hero_image_url !== '') : ?>
                     <tr>
                      <td align="center" style="padding:0;Margin:0;font-size:0"><img src="<?php echo esc_url($hero_image_url); ?>" alt="" width="560" referrerpolicy class="adapt-img" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></td>
                     </tr>
					<?php endif; ?>

					 <tr>
                      <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding:15px 40px"><h2 class="es-m-txt-c" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31px;color:#333333"><br></h2><h2 class="es-m-txt-c" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31px;color:#333333"><?php echo esc_html($preheader); ?></h2><h2 class="es-m-txt-c" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31px;color:#333333"><br></h2></td>
                     </tr>



					 <tr>
                      <td align="center" style="padding:10px 0;Margin:0"><h3 class="es-m-txt-c" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:30px;color:#333333"><?php echo wp_kses_post($content); ?></h3></td>
                     </tr>
				...
				<table cellspacing="0" align="center" cellpadding="0" class="es-footer-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:transparent;width:600px" role="none">
					<tbody>
						<tr>
                          ...
                          <td valign="top" align="center" class="es-m-p40r" style="padding:0 40px 0 0;Margin:0"><a href="https://www.instagram.com/jazz_cafe_dizzy" target="_blank" style="mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px;font-weight:inherit"><img alt="Inst" width="32" title="Instagram" src="<?php echo esc_url(DIZZY_EMAILS_URL . 'assets/images/instagram-logo-black.png'); ?>" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></a></td>
                          <td valign="top" align="center" style="padding:0;Margin:0"><a target="_blank" href="https://www.tiktok.com/discover/jazz-cafe-dizzy-rotterdam" style="mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px;font-weight:inherit"><img alt="TT" width="32" title="TikTok" src="<?php echo esc_url(DIZZY_EMAILS_URL . 'assets/images/tiktok-logo-black.png'); ?>" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></a></td>
                         </tr>
                        </tbody>
                       </table></td>
                     </tr>
                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tbody>
                     <tr>
                      <td align="center" class="es-infoblock" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;font-weight:normal;color:#CCCCCC;font-size:12px">No longer want to receive these emails?&nbsp;<a href="<?php echo esc_url($unsubscribe_url); ?>" target="_blank" style="mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px;font-weight:inherit">Unsubscribe</a>.</p></td>
                     </tr>
                    </tbody>
                   </table></td>
                 </tr>
