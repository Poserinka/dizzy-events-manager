                     ...
                     <tr>
                      <td align="center" valign="top" style="padding:0;Margin:0;width:556px">
                       <table cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;width:556px">
                         ...
                         <tr>
                          <td align="center" class="es-m-text" style="padding:10px 0;Margin:0"><h3 class="es-m-txt-c" style="Margin:0;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:600;line-height:30px;color:#333333"><?php esc_html_e('Your tickets are ready', 'dizzy-ticket-manager'); ?><br /><?php echo esc_html((string) $event_name); ?><br /><?php echo esc_html((string) $event_date); ?> - <?php echo esc_html((string) $event_time); ?><br />TOTAL PRICE: <?php echo esc_html((string) $currency . ' ' . (string) $total_amount); ?></h3>
                            </td>
                         </tr>
                         ...
                         <tr>
                          <td align="center" class="es-m-text" style="padding:10px 0 5px;Margin:0"><h3 class="es-m-txt-c" style="Margin:0;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:600;line-height:30px;color:#333333"><?php echo esc_html((string) $customer_name); ?><br /><?php echo esc_html((string) $customer_email); ?><br /><?php echo esc_html((string) $customer_phone); ?><br />RESERVATION NUMBER: <?php echo esc_html(sprintf(__('Order number: %d', 'dizzy-ticket-manager'), (int) $order_id)); ?></h3></td>
                         </tr>
                         <tr>
                          <td align="center" style="padding:20px 0 20px;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;letter-spacing:0;font-weight:normal;color:#333333;font-size:14px">You can&nbsp;cancel your&nbsp;reservation by reaching us via phone.</p></td>
                         </tr>
                         <tr>
                          <td align="center" style="padding:15px 0;Margin:0;font-size:0">
                           <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                             <tr>
                              <td align="center" valign="top" class="es-m-p40r" style="padding:0 40px 0 0;Margin:0"><a href="https://www.facebook.com/DizzyJazz/" target="_blank" style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px;font-weight:inherit"><img alt="Fb" width="32" title="Facebook" src="https://ezqppko.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></a></td>
                              <td valign="top" align="center" class="es-m-p40r" style="padding:0 40px 0 0;Margin:0"><a href="https://www.instagram.com/jazz_cafe_dizzy" target="_blank" style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px;font-weight:inherit"><img alt="Inst" width="32" title="Instagram" src="https://ezqppko.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></a></td>
                              <td valign="top" align="center" style="padding:0;Margin:0"><a target="_blank" href="https://www.tiktok.com/discover/jazz-cafe-dizzy-rotterdam" style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px;font-weight:inherit"><img alt="TT" width="32" title="TikTok" src="https://ezqppko.stripocdn.email/content/assets/img/social-icons/logo-black/tiktok-logo-black.png" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></a></td>
                             </tr>
                           </table></td>
                         </tr>
                         <tr>
