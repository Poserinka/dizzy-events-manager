...
final class AutoPostAdmin
{
    ...
    public function render(): void
    {
        ...
        <div class="wrap dizzy-social-page"><div class="dizzy-social-page-header"><h1><?php esc_html_e('Auto Post Settings','dizzy-social-media-manager'); ?></h1></div><form method="post" action="options.php"><?php settings_fields(self::GROUP); ?>
