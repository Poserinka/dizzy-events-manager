...
final class AutoPostAdmin
{
    ...
    public function render(): void
    {
        ...
        <div class="wrap dizzy-social-page"><div class="dizzy-social-page-header dizzy-editor-header"><div><h1><?php esc_html_e('Auto Post Settings','dizzy-social-media-manager'); ?></h1><p><?php esc_html_e('Control automatic sharing and review recent activity.', 'dizzy-social-media-manager'); ?></p></div></div><form method="post" action="options.php"><?php settings_fields(self::GROUP); ?>
