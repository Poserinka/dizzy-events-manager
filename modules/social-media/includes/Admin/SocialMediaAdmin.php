...
final class SocialMediaAdmin
{
    ...
    public function render(): void
    {
        ...
        echo '<table class="widefat striped dizzy-social-generator-table"><thead><tr><th>' . esc_html__('Event', 'dizzy-social-media-manager') . '</th><th>' . esc_html__('Status', 'dizzy-social-media-manager') . '</th><th>' . esc_html__('Latest poster', 'dizzy-social-media-manager') . '</th><th>' . esc_html__('Action', 'dizzy-social-media-manager') . '</th></tr></thead><tbody>';
